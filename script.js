...
<div class="modal-footer">
 <a href="${url}" class="btn btn-danger" download target="__blank">Download</a>
</div>
</div>
  </div>
</div>
...
fetch("https://www.eporner.com/api/v2/video/search/per_page=1000&lq=0    &order=latest&gay=0&page="+pg )    .then(resp=> resp.json())       .then((data) => {            $(".preloader").remove();            const videos = data.videos;
